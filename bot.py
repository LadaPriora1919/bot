...
qty = 12.0
different_dict = {'SCRT': 0.001, 'SC': 0.00001, 'ONE': 0.00001, 'SUSHI': 0.001, 'ROSE': 0.00001, 'CELO': 0.001, 'AR': 0.01, 'NEO': 0.01, 'XTZ': 0.001, 'T': 0.0001, 'ALGO': 0.0001, 'OP': 0.001, 'EGLD': 0.01, 'FLOW': 0.001, 'LIT': 0.001, 'ENS': 0.01, 'QNT': 0.1, 'XMR': 0.1, 'MDX': 0.0001, 'XLM': 0.0001, 'SLP': 0.00001, 'RVN': 0.00001, 'ATOM': 0.001, 'SAND': 0.0001, 'CHZ': 0.0001, 'MASK': 0.001, 'ANT': 0.001, 'RUNE': 0.001, 'MANA': 0.0001, 'MTL': 0.001, 'DYDX': 0.001, 'KNC': 0.001, 'ZIL': 0.00001, 'GMT': 0.0001, 'UNI': 0.001, 'FTM': 0.0001, 'WAVES': 0.001, 'LDO': 0.001, 'FIL': 0.001, 'DOT': 0.001, 'GAL': 0.001, 'APE': 0.001, 'NEAR': 0.001, 'SOL': 0.01, 'MATIC': 0.0001, 'KAVA': 0.001, 'DOGE': 0.00001, 'LINK': 0.001, 'VET': 0.00001, 'DASH': 0.01, 'BNB': 0.1, 'ACH': 0.00001, '1INCH': 0.001, 'AAVE': 0.1, 'BCH': 0.1, 'LTC': 0.01, 'XRP': 0.0001, 'ETC': 0.01, 'ADA': 0.0001, 'EOS': 0.001, 'TRX': 0.00001}

symbols_1 = ['ONE', 'XTZ', 'AR', 'BNB', '1INCH', 'BCH', 'LTC', 'VET', 'KAVA', 'NEAR', 'DOT', 'WAVES', 'KNC', 'DYDX', 'OP', 'MANA', 'EGLD', 'RVN', 'SLP', 'ALGO']
symbols_2 = ['SC', 'SUSHI', 'NEO', 'ACH', 'XRP', 'ETC', 'DASH', 'LINK', 'MATIC', 'APE', 'FIL', 'FTM', 'ZIL', 'MTL', 'SAND', 'RUNE', 'LIT', 'ATOM', 'MDX', 'QNT']
symbols_3 = ['SCRT', 'ROSE', 'CELO', 'ADA', 'AAVE', 'EOS', 'TRX', 'DOGE', 'SOL', 'GAL', 'LDO', 'UNI', 'GMT', 'ANT', 'MASK', 'T', 'CHZ', 'ENS', 'XLM', 'XMR', 'FLOW']
print(len(symbols_1) + len(symbols_2) + len(symbols_3))
    ...
    while True:
        try:
            for symbol in crypto_symbol:
                ...
                percent = ((second - different_dict[symbol]) / (third + different_dict[symbol]) - 1) * 100 - 0.225
                print(symbol)
                ...
                while percent >= 0.05:
                    ...
                    first, second, third = get_prices(symbol)
                    percent = ((second - different_dict[symbol]) / (third + different_dict[symbol]) - 1) * 100 - 0.225
                percent = ((third - different_dict[symbol]) / (second + different_dict[symbol]) - 1) * 100 - 0.225
                print(symbol)
                print(third - different_dict[symbol], 'USDT')
                print(second + different_dict[symbol], 'BUSD')
                print(percent)
                while percent >= 0.05:
                    ...
                    percent = ((third - different_dict[symbol]) / (second + different_dict[symbol]) - 1) * 100 - 0.225
                requests.get(
                    'https://api.telegram.org/bot5830540536:AAF9vZCbTJmsvNoLTNzcs6dDmn5dFnBDaJ8/sendMessage?chat_id=400635213&text=' + symbol)
